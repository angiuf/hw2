<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ url('css/modale.css') }}">
        <meta name="viewport"content="width=device-width, initial-scale=1"> 
        <link rel="preconnect" href="https://fonts.gstatic.com">
        <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@700&display=swap" rel="stylesheet">     
        <link rel="preconnect" href="https://fonts.gstatic.com">
        <link href="https://fonts.googleapis.com/css2?family=Montserrat&display=swap" rel="stylesheet"> 
        <script src="{{ url('js/home.js') }}" defer charset="UTF-8"></script> 
        <script src="{{ url('js/birre_API.js') }}" defer charset="UTF-8"></script>
        <script src="{{ url('js/edamam_API.js') }}" defer charset="UTF-8"></script>
