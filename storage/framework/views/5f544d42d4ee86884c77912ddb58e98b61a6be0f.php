<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(url('css/i_miei_ordini.css')); ?>">
        <meta name="viewport"content="width=device-width, initial-scale=1"> 
        <link rel="preconnect" href="https://fonts.gstatic.com">
        <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@700&display=swap" rel="stylesheet">     
        <link rel="preconnect" href="https://fonts.gstatic.com">
        <link href="https://fonts.googleapis.com/css2?family=Montserrat&display=swap" rel="stylesheet"> 
        <script src="<?php echo e(url('js/i_miei_ordini.js')); ?>" defer charset="UTF-8"></script>
    </head>
    <body>
        <nav>
            <div class='left'>
...
</html><?php /**PATH C:\xampp\htdocs\hw2\resources\views/orders.blade.php ENDPATH**/ ?>